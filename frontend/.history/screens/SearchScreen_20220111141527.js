                        ...
                        onPress={ () => {
                            firestore()
                                ...
                                .add({
                                    ...
                                    image: `https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&maxheight=400&photoreference=${LocData.photos[0].photo_reference}&key=AIzaSyAoqlQ1Mipy61k3DhUoX6B5AikDWmS-3lI`,
                                    types: LocData.types,
